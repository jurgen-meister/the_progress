...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Por favor arrelge este campo.",
		...
		creditcard: "Por favor ingrese una tarjeta de cretido valida.",
		...
		rangelength: $.validator.format("Por favor ingrese un valor entre {0} y {1} carateres."),
