...
<?php echo $this->Html->script('modules/PurGraphicsNew', FALSE); ?>
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Gráficas de Compras</h5>
                </div>
                <div class="widget-content nopadding">
                    <?php echo $this->BootstrapForm->create('PurPurchase', array('class' => 'form-horizontal', 'novalidate' => true)); ?>
                    <?php
