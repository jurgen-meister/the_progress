...
<!-- ************************************************************************************************************************ -->
		<h3>
<?php echo __(' Egresos de Almacén por Ventas');?></h3>
			...
			<fieldset>
						...
						*/
						echo $this->BootstrapForm->input('note_code', array(				
								...
								'id'=>'txtNoteCode',
								'value'=>$note_code,
								'placeholder'=>'No. Nota de Remisión'
								));
		...
		<table class="table table-striped table-bordered table-hover">
			<tr>
				...
				<th><?php echo 'No. Nota de Remisión';?></th>
				<th><?php echo $this->BootstrapPaginator->sort('inv_warehouse_id', 'Almacen Origen');?></th>
				<th><?php echo $this->BootstrapPaginator->sort('type', 'Tipo de Movimiento');?></th>
		...
		<?php foreach ($invMovements as $invMovement): ?>
			<tr>
				...
				<td>
					<?php //echo h($invMovement['InvMovement']['type']); 
						$movementDocType = $invMovement['InvMovement']['type'];
						switch ($movementDocType){
									case 1:
										echo "Disponible";
										break;
									case 2:
