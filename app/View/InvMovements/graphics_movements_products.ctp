...
<?php echo $this->Html->script('modules/InvGraphicsNew', FALSE); ?>
...
<div class="span12"><!-- START CONTAINER FLUID/ROW FLUID/SPAN12 - FROM MAIN TEMPLATE #UNICORN -->
    ...
    <!--    <div class="widget-box">
            <div class="widget-content nopadding">
                <a href="#" id="btnGenerateGraphics" class="btn btn-primary noPrint "><i class="icon-cog icon-white"></i> Generar Gráficas (abajo)</a>
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Gráficas de Movimientos de Almacen</h5>
                </div>
                <div class="widget-content nopadding">
