...
?>		
<div style="font-size: 20px; font-weight: bold; text-align:center; text-decoration: underline;">VENTAS POR VENDEDOR<?php echo $reportTypeName;?>: <?php echo strtoupper($initialData['showByTypeName']);?></div>
<br>
...
<?php 
	...
	foreach($salesmenMovements as $val){ 
	$quantityTotal = 0;
	$countMovements = 0;
...
?>
	<table class="report-table" border="0" style="border-collapse:collapse; width:100%;">
		<tr>
			<td colspan="2" ><span style="font-weight:bold;">Cliente: </span><?php echo $val['AdmProfile']['full_name']; ?></td>
		</tr>
	</table>	
